...
export const leadership: LeadershipPerson[] = [
  {
    ...
    fullBio: [
      ...
      'His collaborations include work with acclaimed choreographers such as Debbie Allen, Donald Byrd, Alonzo King, Rennie Harris, Robert Battle, Ronald K. Brown, Robert Garland, Hinton Battle, George Faison, Francesca Harper, Frank Gatson, Louis Johnson, Keith Lee, Pascal Rioult, Garth Fagan, Kevin Jeff, Milton Meyers, Dwight Rhoden, Walter Nicks, Jennifer Muller, Barak Marshall, Elisa Monte, David Brown, and Kevin Wynn.',
