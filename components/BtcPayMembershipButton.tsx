...
export default function BtcPayMembershipButton({
  ...
  return (
    <div className="w-full">
      ...
      >
        <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-accent text-[11px] font-bold leading-none text-accent-fg" aria-hidden="true">
          ₿
        </span>
