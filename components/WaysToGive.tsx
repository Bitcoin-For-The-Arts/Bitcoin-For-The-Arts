                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4">
                    {renderCta(
                      href,
                      w.ctaLabel,
                      'inline-flex min-h-12 w-full items-center justify-center rounded-md bg-accent px-5 py-3 text-sm font-semibold text-black transition-colors hover:opacity-90',
                    )}
                  </div>
                </div>
              ) : null}
