              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6">
                    <Link
                      href={`/about/leadership/${p.slug}`}
                      className="inline-flex min-h-12 items-center justify-center rounded-md bg-accent px-5 py-3 text-sm font-semibold text-black transition-colors hover:opacity-90"
                    >
                      View full bio
                    </Link>
                  </div>
