...
export const metadata: Metadata = {
  ...
  description:
    'Artist invitation: share your Bitcoin journey and artistic evolution with Bitcoin For The Arts.',
};
      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
        ...
        <section className="mt-10 grid grid-cols-1 gap-6 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-7 rounded-2xl border border-border bg-surface/70 p-6">
            <h2 className="text-xl font-semibold tracking-tight">Tell us your story</h2>
            <p className="mt-2 text-sm leading-relaxed text-muted">
