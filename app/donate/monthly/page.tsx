                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        {hasBtcMonthly ? (
                          ...
                          >
                            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-accent text-[11px] font-bold leading-none text-accent-fg" aria-hidden="true">₿</span>
