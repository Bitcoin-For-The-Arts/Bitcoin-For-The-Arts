...
//     hero column (cream field matches the page background).
...
//     background.
//   Both transparent files are generated by:
//   `node scripts/build-transparent-main-lockup.mjs`
  ...
  return (
    <main className="bg-background">
      ...
      {/* Main lockup — sits directly below the intro video as the brand
          "centerpiece". Native <picture> swaps to the dark-mode (cream-on-
          transparent) variant when the OS reports prefers-color-scheme:dark
          so the lockup blends into the ember background. Light mode is the
