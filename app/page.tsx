...
//     hero column. v2 (black BTA + orange Arts) is the colorway match for
//     the main lockup so the page reads as one consistent piece.
...
//     with no visible card edge. Generated by:
//     `node scripts/build-transparent-main-lockup.mjs`
const HOME_BUG_SRC = '/BFTA-bug-square-cream-orange-2.png';
